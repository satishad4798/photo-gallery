 ...
 --> <a class="nav-link" href="addvideo.php">add videos</a>
                  ...
                  <div class="row m-4">
                    ...
                    <div class="col-sm-8" style="background:  #eaeae1">
                      ...
                      if (isset($_GET['watch_id'])) {
                        $id = $_GET['watch_id'];
                        $fetchVideos = mysqli_query($con, "SELECT * FROM photos where id=$id");
                      } elseif (isset($_GET['filter']) and $_GET['filter'] != 'any') {
                        $filter = $_GET['filter'];
                        $fetchVideos = mysqli_query($con, "SELECT * FROM photos WHERE tags LIKE '%$filter%' limit 1   ");
                      } else
                        $fetchVideos = mysqli_query($con, "SELECT * FROM photos ORDER BY rating DESC limit 1");
                      ...
                      while ($row = mysqli_fetch_assoc($fetchVideos)) { ?>
                        ...
                        <div style="object-fit: fill;border-color: red;border-color: red;">
                          ...
                          <div>
                            <p> <?php echo $name[0];  ?> </p>
                            <img src='<?php echo $location  ?>' width="100%">
                ...
                <input class="bg-white" id="myInput2" type="text" name="name" placeholder="search tags">
                      ...
                      <!-- all tags -->
                      <?php
                      $fetchVideos = mysqli_query($con, "SELECT tags FROM photos ORDER BY id DESC");
                      $alltags = "";
                      while ($row = mysqli_fetch_assoc($fetchVideos)) {
...
-->
                      ...
                      if (isset($_GET['filter']) and $_GET['filter'] != 'any') {
                        $filter = $_GET['filter'];
                        $fetchVideos = mysqli_query($con, "SELECT * FROM photos WHERE tags LIKE '%$filter%'  ");
                      } else
                        $fetchVideos = mysqli_query($con, "SELECT * FROM photos ORDER BY rating DESC");
                      ...
                      while ($row = mysqli_fetch_assoc($fetchVideos)) { ?>
                        ...
                        <div style="object-fit: fill;border-color: red;border-color: red;">
                          ...
                          <div class="bg-dark">
                            ...
                            <img src='<?php echo $location  ?>' controls loop autoplay muted width='50%'>
                            <!--  <?php
             ...
             -->
                          ...
                          <div class="row">
                            <div class="col-sm-3">
                              <button class="btn form-check-inline btn-success" onclick="window.location.href='video2.php?watch_id=<?php echo $id ?> '">SEE </button>
